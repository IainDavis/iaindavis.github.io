...
:::note Editor's Note
See the detailed [project page][project-page]
...
[project-page]:
    http://localhost:3000/docs/projects/cover-letter-automation/
    "Detailed Project Page for Automated Cover-Letter Generation Project"