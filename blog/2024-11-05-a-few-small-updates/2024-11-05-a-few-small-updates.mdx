...
1. Upgrading Docusaurus: `v3.5.2` → `v3.6.0`
    ...
    Happily looking forward to improved mermaid support. Hopefully I can take advantage of interactive menus in rendered mermaid diagrams, though I haven't tested this, and it may require some additional configuration to override the default mermaid implementation for a newer one.
1. Added a separate instance of the Docusaurus blog plugin
